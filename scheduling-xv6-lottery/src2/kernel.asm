...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 9f 7c 10 80 	movl   $0x80107c9f,(%esp)
...
80102088:	68 86 7a 10 80       	push   $0x80107a86
...
801037fa:	68 20 1d 11 80       	push   $0x80111d20
  p->pid = nextpid++;
801037ff:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
  release(&ptable.lock);
80103805:	e8 56 0e 00 00       	call   80104660 <release>
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 ef 59 10 80 	movl   $0x801059ef,0x14(%eax)
  p->context = (struct context*)sp;
...
80103839:	e8 42 0f 00 00       	call   80104780 <memset>
...
80103862:	e8 f9 0d 00 00       	call   80104660 <release>
}
...
801038e0:	69 05 04 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a004,%eax
801038e7:	4e c6 41 
801038ea:	05 39 30 00 00       	add    $0x3039,%eax
801038ef:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
801038f4:	a3 04 a0 10 80       	mov    %eax,0x8010a004
}
801038f9:	c3                   	ret    
...
80103906:	5d                   	pop    %ebp
    rand_seed = new_seed;
80103907:	a3 04 a0 10 80       	mov    %eax,0x8010a004
}
8010390c:	c3                   	ret    
8010390d:	8d 76 00             	lea    0x0(%esi),%esi

80103910 <procstat>:
int procstat(struct pstat* st) {
80103910:	55                   	push   %ebp
80103911:	89 e5                	mov    %esp,%ebp
80103913:	83 ec 14             	sub    $0x14,%esp
	acquire(&ptable.lock);
80103916:	68 20 1d 11 80       	push   $0x80111d20
8010391b:	e8 a0 0d 00 00       	call   801046c0 <acquire>
	for (int i = 0; i < NPROC; ++i) {
80103920:	8b 55 08             	mov    0x8(%ebp),%edx
80103923:	b8 60 1d 11 80       	mov    $0x80111d60,%eax
80103928:	83 c4 10             	add    $0x10,%esp
8010392b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010392f:	90                   	nop
		st->inuse[i] = ptable.proc[i].state != UNUSED;
80103930:	31 c9                	xor    %ecx,%ecx
80103932:	83 38 00             	cmpl   $0x0,(%eax)
80103935:	0f 95 c1             	setne  %cl
80103938:	89 0a                	mov    %ecx,(%edx)
		if (st->inuse[i]) {
8010393a:	74 1b                	je     80103957 <procstat+0x47>
			st->tickets[i] = ptable.proc[i].tickets;
8010393c:	8b 48 70             	mov    0x70(%eax),%ecx
8010393f:	89 8a 00 01 00 00    	mov    %ecx,0x100(%edx)
			st->pid[i] = ptable.proc[i].pid;
80103945:	8b 48 04             	mov    0x4(%eax),%ecx
80103948:	89 8a 00 02 00 00    	mov    %ecx,0x200(%edx)
			st->ticks[i] = ptable.proc[i].ticks;
8010394e:	8b 48 74             	mov    0x74(%eax),%ecx
80103951:	89 8a 00 03 00 00    	mov    %ecx,0x300(%edx)
	for (int i = 0; i < NPROC; ++i) {
80103957:	05 84 00 00 00       	add    $0x84,%eax
8010395c:	83 c2 04             	add    $0x4,%edx
8010395f:	3d 60 3e 11 80       	cmp    $0x80113e60,%eax
80103964:	75 ca                	jne    80103930 <procstat+0x20>
	release(&ptable.lock);
80103966:	83 ec 0c             	sub    $0xc,%esp
80103969:	68 20 1d 11 80       	push   $0x80111d20
8010396e:	e8 ed 0c 00 00       	call   80104660 <release>
}
80103973:	31 c0                	xor    %eax,%eax
80103975:	c9                   	leave  
80103976:	c3                   	ret    
...
80103986:	68 80 78 10 80       	push   $0x80107880
8010398b:	68 20 1d 11 80       	push   $0x80111d20
80103990:	e8 5b 0b 00 00       	call   801044f0 <initlock>
}
...
80103a31:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a37:	e8 84 0b 00 00       	call   801045c0 <popcli>
}
...
80103a5c:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a5e:	a3 54 3e 11 80       	mov    %eax,0x80113e54
  if((p->pgdir = setupkvm()) == 0)
80103a63:	e8 78 35 00 00       	call   80106fe0 <setupkvm>
80103a68:	89 43 04             	mov    %eax,0x4(%ebx)
80103a6b:	85 c0                	test   %eax,%eax
80103a6d:	0f 84 ce 00 00 00    	je     80103b41 <userinit+0xf1>
...
80103a81:	e8 0a 32 00 00       	call   80106c90 <inituvm>
...
80103a96:	e8 e5 0c 00 00       	call   80104780 <memset>
...
80103aef:	68 b0 78 10 80       	push   $0x801078b0
80103af4:	50                   	push   %eax
80103af5:	e8 46 0e 00 00       	call   80104940 <safestrcpy>
  p->cwd = namei("/");
80103afa:	c7 04 24 b9 78 10 80 	movl   $0x801078b9,(%esp)
80103b01:	e8 9a e5 ff ff       	call   801020a0 <namei>
  p->tickets = 1;  // initial process has 1 ticket
80103b06:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  p->cwd = namei("/");
80103b0d:	89 43 68             	mov    %eax,0x68(%ebx)
	p->ticks = 0;
80103b10:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
80103b17:	00 00 00 
  acquire(&ptable.lock);
80103b1a:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103b21:	e8 9a 0b 00 00       	call   801046c0 <acquire>
  p->state = RUNNABLE;
80103b26:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103b2d:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103b34:	e8 27 0b 00 00       	call   80104660 <release>
}
...
80103b44:	68 97 78 10 80       	push   $0x80107897
80103b49:	e8 32 c8 ff ff       	call   80100380 <panic>
...
80103b58:	e8 13 0a 00 00       	call   80104570 <pushcli>
  c = mycpu();
80103b5d:	e8 3e fe ff ff       	call   801039a0 <mycpu>
  p = c->proc;
...
80103b7b:	e8 00 30 00 00       	call   80106b80 <switchuvm>
  return 0;
...
80103b9a:	e8 61 32 00 00       	call   80106e00 <allocuvm>
...
80103bba:	e8 71 33 00 00       	call   80106f30 <deallocuvm>
...
80103bd9:	e8 92 09 00 00       	call   80104570 <pushcli>
  c = mycpu();
80103bde:	e8 bd fd ff ff       	call   801039a0 <mycpu>
  p = c->proc;
...
80103c77:	89 47 68             	mov    %eax,0x68(%edi)
  np->tickets = curproc->tickets; // child has same number of tickets as parent
80103c7a:	8b 43 10             	mov    0x10(%ebx),%eax
  np->ticks = 0;
80103c7d:	c7 87 80 00 00 00 00 	movl   $0x0,0x80(%edi)
80103c84:	00 00 00 
  np->tickets = curproc->tickets; // child has same number of tickets as parent
80103c87:	89 47 7c             	mov    %eax,0x7c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103c8a:	8d 47 6c             	lea    0x6c(%edi),%eax
80103c8d:	6a 10                	push   $0x10
80103c8f:	53                   	push   %ebx
80103c90:	50                   	push   %eax
80103c91:	e8 aa 0c 00 00       	call   80104940 <safestrcpy>
  pid = np->pid;
80103c96:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103c99:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103ca0:	e8 1b 0a 00 00       	call   801046c0 <acquire>
  np->state = RUNNABLE;
80103ca5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103cac:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103cb3:	e8 a8 09 00 00       	call   80104660 <release>
  return pid;
...
80103cf0:	eb c9                	jmp    80103cbb <fork+0xeb>
...
80103d06:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103d09:	e8 92 fc ff ff       	call   801039a0 <mycpu>
  c->proc = 0;
80103d0e:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103d15:	00 00 00 
  struct cpu *c = mycpu();
80103d18:	89 c3                	mov    %eax,%ebx
  c->proc = 0;
80103d1a:	8d 70 04             	lea    0x4(%eax),%esi
...
80103d29:	e8 92 09 00 00       	call   801046c0 <acquire>
80103d2e:	83 c4 10             	add    $0x10,%esp
		int total_tickets = 0;
80103d31:	31 c9                	xor    %ecx,%ecx
		for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d33:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103d38:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103d3f:	90                   	nop
			if (p->state == RUNNABLE) total_tickets += p->tickets;
80103d40:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103d44:	75 03                	jne    80103d49 <scheduler+0x49>
80103d46:	03 48 7c             	add    0x7c(%eax),%ecx
		for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d49:	05 84 00 00 00       	add    $0x84,%eax
80103d4e:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103d53:	75 eb                	jne    80103d40 <scheduler+0x40>
		if (total_tickets > 0) {
80103d55:	85 c9                	test   %ecx,%ecx
80103d57:	7e 7a                	jle    80103dd3 <scheduler+0xd3>
    rand_seed = (RAND_MULTIPLIER * rand_seed + RAND_INCREMENT) % RAND_MODULUS;
80103d59:	69 05 04 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a004,%eax
80103d60:	4e c6 41 
			int rnum = rand() % total_tickets;
80103d63:	31 d2                	xor    %edx,%edx
			for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d65:	bf 54 1d 11 80       	mov    $0x80111d54,%edi
    rand_seed = (RAND_MULTIPLIER * rand_seed + RAND_INCREMENT) % RAND_MODULUS;
80103d6a:	05 39 30 00 00       	add    $0x3039,%eax
80103d6f:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
80103d74:	a3 04 a0 10 80       	mov    %eax,0x8010a004
			int rnum = rand() % total_tickets;
80103d79:	f7 f1                	div    %ecx
			for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d7b:	eb 11                	jmp    80103d8e <scheduler+0x8e>
80103d7d:	8d 76 00             	lea    0x0(%esi),%esi
80103d80:	81 c7 84 00 00 00    	add    $0x84,%edi
80103d86:	81 ff 54 3e 11 80    	cmp    $0x80113e54,%edi
80103d8c:	74 45                	je     80103dd3 <scheduler+0xd3>
				if (p->state != RUNNABLE)
80103d8e:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103d92:	75 ec                	jne    80103d80 <scheduler+0x80>
				if (rnum < 0) {
80103d94:	2b 57 7c             	sub    0x7c(%edi),%edx
80103d97:	79 e7                	jns    80103d80 <scheduler+0x80>
					switchuvm(p);
80103d99:	83 ec 0c             	sub    $0xc,%esp
					c->proc = p;
80103d9c:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
					switchuvm(p);
80103da2:	57                   	push   %edi
80103da3:	e8 d8 2d 00 00       	call   80106b80 <switchuvm>
					swtch(&(c->scheduler), p->context);
80103da8:	58                   	pop    %eax
80103da9:	5a                   	pop    %edx
80103daa:	ff 77 1c             	push   0x1c(%edi)
80103dad:	56                   	push   %esi
					p->ticks++;
80103dae:	83 87 80 00 00 00 01 	addl   $0x1,0x80(%edi)
					p->state = RUNNING;
80103db5:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
					swtch(&(c->scheduler), p->context);
80103dbc:	e8 da 0b 00 00       	call   8010499b <swtch>
					switchkvm();
80103dc1:	e8 aa 2d 00 00       	call   80106b70 <switchkvm>
					break;
80103dc6:	83 c4 10             	add    $0x10,%esp
					c->proc = 0;
80103dc9:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103dd0:	00 00 00 
    release(&ptable.lock);
80103dd3:	83 ec 0c             	sub    $0xc,%esp
80103dd6:	68 20 1d 11 80       	push   $0x80111d20
80103ddb:	e8 80 08 00 00       	call   80104660 <release>
  for(;;){
80103de0:	83 c4 10             	add    $0x10,%esp
80103de3:	e9 38 ff ff ff       	jmp    80103d20 <scheduler+0x20>
...
80103df5:	e8 76 07 00 00       	call   80104570 <pushcli>
  c = mycpu();
80103dfa:	e8 a1 fb ff ff       	call   801039a0 <mycpu>
  p = c->proc;
...
80103e1c:	74 4f                	je     80103e6d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103e1e:	e8 7d fb ff ff       	call   801039a0 <mycpu>
...
80103e37:	75 41                	jne    80103e7a <sched+0x8a>
  intena = mycpu()->intena;
80103e39:	e8 62 fb ff ff       	call   801039a0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e3e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e41:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e47:	e8 54 fb ff ff       	call   801039a0 <mycpu>
...
80103e53:	e8 43 0b 00 00       	call   8010499b <swtch>
  mycpu()->intena = intena;
80103e58:	e8 43 fb ff ff       	call   801039a0 <mycpu>
}
...
80103eb6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103eb9:	e8 62 fb ff ff       	call   80103a20 <myproc>
  if(curproc == initproc)
80103ebe:	39 05 54 3e 11 80    	cmp    %eax,0x80113e54
80103ec4:	0f 84 07 01 00 00    	je     80103fd1 <exit+0x121>
...
80103ee2:	e8 09 d0 ff ff       	call   80100ef0 <fileclose>
      curproc->ofile[fd] = 0;
...
80103ef5:	75 e1                	jne    80103ed8 <exit+0x28>
  begin_op();
80103ef7:	e8 64 ee ff ff       	call   80102d60 <begin_op>
  iput(curproc->cwd);
80103efc:	83 ec 0c             	sub    $0xc,%esp
80103eff:	ff 73 68             	push   0x68(%ebx)
80103f02:	e8 a9 d9 ff ff       	call   801018b0 <iput>
  end_op();
80103f07:	e8 c4 ee ff ff       	call   80102dd0 <end_op>
  curproc->cwd = 0;
...
80103f2a:	eb 10                	jmp    80103f3c <exit+0x8c>
80103f2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f30:	05 84 00 00 00       	add    $0x84,%eax
80103f35:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103f3a:	74 1e                	je     80103f5a <exit+0xaa>
    if(p->state == SLEEPING && p->chan == chan)
80103f3c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103f40:	75 ee                	jne    80103f30 <exit+0x80>
80103f42:	3b 50 20             	cmp    0x20(%eax),%edx
80103f45:	75 e9                	jne    80103f30 <exit+0x80>
      p->state = RUNNABLE;
80103f47:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f4e:	05 84 00 00 00       	add    $0x84,%eax
80103f53:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103f58:	75 e2                	jne    80103f3c <exit+0x8c>
      p->parent = initproc;
80103f5a:	8b 0d 54 3e 11 80    	mov    0x80113e54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f60:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
80103f65:	eb 17                	jmp    80103f7e <exit+0xce>
80103f67:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103f6e:	66 90                	xchg   %ax,%ax
80103f70:	81 c2 84 00 00 00    	add    $0x84,%edx
80103f76:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
80103f7c:	74 3a                	je     80103fb8 <exit+0x108>
    if(p->parent == curproc){
80103f7e:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103f81:	75 ed                	jne    80103f70 <exit+0xc0>
      if(p->state == ZOMBIE)
80103f83:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103f87:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103f8a:	75 e4                	jne    80103f70 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f8c:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103f91:	eb 11                	jmp    80103fa4 <exit+0xf4>
80103f93:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f97:	90                   	nop
80103f98:	05 84 00 00 00       	add    $0x84,%eax
80103f9d:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103fa2:	74 cc                	je     80103f70 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80103fa4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103fa8:	75 ee                	jne    80103f98 <exit+0xe8>
80103faa:	3b 48 20             	cmp    0x20(%eax),%ecx
80103fad:	75 e9                	jne    80103f98 <exit+0xe8>
      p->state = RUNNABLE;
80103faf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103fb6:	eb e0                	jmp    80103f98 <exit+0xe8>
  curproc->state = ZOMBIE;
80103fb8:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103fbf:	e8 2c fe ff ff       	call   80103df0 <sched>
  panic("zombie exit");
80103fc4:	83 ec 0c             	sub    $0xc,%esp
80103fc7:	68 08 79 10 80       	push   $0x80107908
80103fcc:	e8 af c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fd1:	83 ec 0c             	sub    $0xc,%esp
80103fd4:	68 fb 78 10 80       	push   $0x801078fb
80103fd9:	e8 a2 c3 ff ff       	call   80100380 <panic>
...
80103fe5:	e8 86 05 00 00       	call   80104570 <pushcli>
  c = mycpu();
80103fea:	e8 b1 f9 ff ff       	call   801039a0 <mycpu>
  p = c->proc;
...
8010401e:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80104024:	74 1e                	je     80104044 <wait+0x64>
      if(p->parent != curproc)
80104026:	39 73 14             	cmp    %esi,0x14(%ebx)
80104029:	75 ed                	jne    80104018 <wait+0x38>
      if(p->state == ZOMBIE){
8010402b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010402f:	74 5f                	je     80104090 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104031:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80104037:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010403c:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80104042:	75 e2                	jne    80104026 <wait+0x46>
    if(!havekids || curproc->killed){
80104044:	85 c0                	test   %eax,%eax
80104046:	0f 84 9a 00 00 00    	je     801040e6 <wait+0x106>
8010404c:	8b 46 24             	mov    0x24(%esi),%eax
8010404f:	85 c0                	test   %eax,%eax
80104051:	0f 85 8f 00 00 00    	jne    801040e6 <wait+0x106>
  pushcli();
80104057:	e8 14 05 00 00       	call   80104570 <pushcli>
  c = mycpu();
8010405c:	e8 3f f9 ff ff       	call   801039a0 <mycpu>
  p = c->proc;
80104061:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104067:	e8 54 05 00 00       	call   801045c0 <popcli>
  if(p == 0)
8010406c:	85 db                	test   %ebx,%ebx
8010406e:	0f 84 89 00 00 00    	je     801040fd <wait+0x11d>
  p->chan = chan;
80104074:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104077:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
8010407e:	e8 6d fd ff ff       	call   80103df0 <sched>
  p->chan = 0;
80104083:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
8010408a:	e9 7b ff ff ff       	jmp    8010400a <wait+0x2a>
8010408f:	90                   	nop
        kfree(p->kstack);
...
80104099:	e8 22 e4 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
8010409e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040a5:	5a                   	pop    %edx
801040a6:	ff 73 04             	push   0x4(%ebx)
801040a9:	e8 b2 2e 00 00       	call   80106f60 <freevm>
        p->pid = 0;
...
80104100:	68 14 79 10 80       	push   $0x80107914
...
80104121:	e8 4a 04 00 00       	call   80104570 <pushcli>
  c = mycpu();
80104126:	e8 75 f8 ff ff       	call   801039a0 <mycpu>
  p = c->proc;
...
8010416f:	e8 fc 03 00 00       	call   80104570 <pushcli>
  c = mycpu();
80104174:	e8 27 f8 ff ff       	call   801039a0 <mycpu>
  p = c->proc;
...
80104209:	68 1a 79 10 80       	push   $0x8010791a
8010420e:	e8 6d c1 ff ff       	call   80100380 <panic>
    panic("sleep");
80104213:	83 ec 0c             	sub    $0xc,%esp
80104216:	68 14 79 10 80       	push   $0x80107914
...
80104257:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010425e:	05 84 00 00 00       	add    $0x84,%eax
80104263:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80104268:	75 e2                	jne    8010424c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010426a:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
80104271:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104274:	c9                   	leave  
  release(&ptable.lock);
80104275:	e9 e6 03 00 00       	jmp    80104660 <release>
...
801042a5:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
...
801042cd:	e8 8e 03 00 00       	call   80104660 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010433f:	74 e7                	je     80104328 <procdump+0x28>
      state = "???";
80104341:	ba 2b 79 10 80       	mov    $0x8010792b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104346:	83 f8 05             	cmp    $0x5,%eax
80104349:	77 11                	ja     8010435c <procdump+0x5c>
8010434b:	8b 14 85 8c 79 10 80 	mov    -0x7fef8674(,%eax,4),%edx
      state = "???";
80104352:	b8 2b 79 10 80       	mov    $0x8010792b,%eax
...
80104361:	68 2f 79 10 80       	push   $0x8010792f
...
8010439d:	68 81 73 10 80       	push   $0x80107381
...
80104433:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104439:	e8 e2 f5 ff ff       	call   80103a20 <myproc>
...
801044db:	e8 40 f5 ff ff       	call   80103a20 <myproc>
...
801045ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801045f0:	e8 ab f3 ff ff       	call   801039a0 <mycpu>
...
80104605:	68 af 79 10 80       	push   $0x801079af
8010460a:	e8 71 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010460f:	83 ec 0c             	sub    $0xc,%esp
80104612:	68 c6 79 10 80       	push   $0x801079c6
...
80104643:	e8 58 f3 ff ff       	call   801039a0 <mycpu>
...
801046fc:	e8 9f f2 ff ff       	call   801039a0 <mycpu>
...
8010475b:	e8 40 f2 ff ff       	call   801039a0 <mycpu>
...
80104770:	68 d5 79 10 80       	push   $0x801079d5
...
801049f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049fa:	e8 21 f0 ff ff       	call   80103a20 <myproc>
...
80104a45:	e8 d6 ef ff ff       	call   80103a20 <myproc>
...
80104a53:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a56:	e8 c5 ef ff ff       	call   80103a20 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a96:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104a99:	e8 82 ef ff ff       	call   80103a20 <myproc>
80104a9e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104aa0:	e8 7b ef ff ff       	call   80103a20 <myproc>
...
80104aae:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ab1:	e8 6a ef ff ff       	call   80103a20 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b04:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b05:	e8 16 ef ff ff       	call   80103a20 <myproc>
...
80104b13:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b16:	e8 05 ef ff ff       	call   80103a20 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b2b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b2e:	e8 ed ee ff ff       	call   80103a20 <myproc>
  if(addr >= curproc->sz)
...
80104b84:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b87:	e8 94 ee ff ff       	call   80103a20 <myproc>
...
80104bc8:	68 dd 79 10 80       	push   $0x801079dd
...
80104d24:	68 7c 7a 10 80       	push   $0x80107a7c
...
80104d3c:	68 7b 7a 10 80       	push   $0x80107a7b
...
80104d51:	68 6f 7a 10 80       	push   $0x80107a6f
...
80104d6f:	68 7e 7a 10 80       	push   $0x80107a7e
80104d74:	e8 07 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d79:	83 ec 0c             	sub    $0xc,%esp
80104d7c:	68 60 7a 10 80       	push   $0x80107a60
...
8010517d:	58                   	pop    %eax
8010517e:	5a                   	pop    %edx
8010517f:	68 7c 7a 10 80       	push   $0x80107a7c
...
80105198:	68 7b 7a 10 80       	push   $0x80107a7b
...
80105387:	74 23                	je     801053ac <sys_open+0x9c>
  struct proc *curproc = myproc();
80105389:	e8 92 e6 ff ff       	call   80103a20 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105545:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105548:	e8 d3 e4 ff ff       	call   80103a20 <myproc>
...
80105717:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105719:	e8 02 e3 ff ff       	call   80103a20 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105757:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010575a:	e8 c1 e2 ff ff       	call   80103a20 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105776:	75 f0                	jne    80105768 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105778:	e8 a3 e2 ff ff       	call   80103a20 <myproc>
...
80105823:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105826:	e8 f5 e1 ff ff       	call   80103a20 <myproc>
...
80105847:	78 27                	js     80105870 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105849:	e8 d2 e1 ff ff       	call   80103a20 <myproc>
  if(growproc(n) < 0)
...
801058df:	73 2f                	jae    80105910 <sys_sleep+0x90>
    if(myproc()->killed){
801058e1:	e8 3a e1 ff ff       	call   80103a20 <myproc>
...
80105960 <sys_settickets>:

// sets no. of tickets in current process
int 
sys_settickets(void) {
...
80105976:	78 18                	js     80105990 <sys_settickets+0x30>
		return -1;
	if (val < 1) return -1;
80105978:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010597b:	85 c0                	test   %eax,%eax
8010597d:	7e 11                	jle    80105990 <sys_settickets+0x30>
	myproc()->tickets = val;
8010597f:	e8 9c e0 ff ff       	call   80103a20 <myproc>
80105984:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105987:	89 50 7c             	mov    %edx,0x7c(%eax)
	return 0;
8010598a:	31 c0                	xor    %eax,%eax
}
8010598c:	c9                   	leave  
8010598d:	c3                   	ret    
...
// returns info on running processes
int
sys_getpinfo(void) {
...
801059a9:	68 00 04 00 00       	push   $0x400
801059ae:	50                   	push   %eax
801059af:	6a 00                	push   $0x0
801059b1:	e8 da f0 ff ff       	call   80104a90 <argptr>
801059b6:	83 c4 10             	add    $0x10,%esp
801059b9:	85 c0                	test   %eax,%eax
801059bb:	78 13                	js     801059d0 <sys_getpinfo+0x30>
		return -1;
	return procstat(st);
801059bd:	83 ec 0c             	sub    $0xc,%esp
801059c0:	ff 75 f4             	push   -0xc(%ebp)
801059c3:	e8 48 df ff ff       	call   80103910 <procstat>
...
80105a17:	c7 04 c5 c2 3e 11 80 	movl   $0x8e000008,-0x7feec13e(,%eax,8)
80105a1e:	08 00 00 8e 
80105a22:	66 89 14 c5 c0 3e 11 	mov    %dx,-0x7feec140(,%eax,8)
80105a29:	80 
80105a2a:	c1 ea 10             	shr    $0x10,%edx
80105a2d:	66 89 14 c5 c6 3e 11 	mov    %dx,-0x7feec13a(,%eax,8)
80105a34:	80 
  for(i = 0; i < 256; i++)
...
80105a3f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a42:	a1 0c a1 10 80       	mov    0x8010a10c,%eax
80105a47:	c7 05 c2 40 11 80 08 	movl   $0xef000008,0x801140c2
80105a4e:	00 00 ef 
  initlock(&tickslock, "time");
80105a51:	68 c1 7a 10 80       	push   $0x80107ac1
80105a56:	68 80 3e 11 80       	push   $0x80113e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a5b:	66 a3 c0 40 11 80    	mov    %ax,0x801140c0
80105a61:	c1 e8 10             	shr    $0x10,%eax
80105a64:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
...
80105a8b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a8f:	b8 c0 3e 11 80       	mov    $0x80113ec0,%eax
...
80105ad4:	ff 24 85 68 7b 10 80 	jmp    *-0x7fef8498(,%eax,4)
...
80105aea:	e8 31 df ff ff       	call   80103a20 <myproc>
80105aef:	85 c0                	test   %eax,%eax
80105af1:	74 1d                	je     80105b10 <trap+0x60>
80105af3:	e8 28 df ff ff       	call   80103a20 <myproc>
...
80105b10:	e8 0b df ff ff       	call   80103a20 <myproc>
80105b15:	85 c0                	test   %eax,%eax
80105b17:	74 0f                	je     80105b28 <trap+0x78>
80105b19:	e8 02 df ff ff       	call   80103a20 <myproc>
...
80105b22:	0f 84 b8 00 00 00    	je     80105be0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b28:	e8 f3 de ff ff       	call   80103a20 <myproc>
80105b2d:	85 c0                	test   %eax,%eax
80105b2f:	74 1d                	je     80105b4e <trap+0x9e>
80105b31:	e8 ea de ff ff       	call   80103a20 <myproc>
...
80105b80:	e8 7b de ff ff       	call   80103a00 <cpuid>
...
80105b91:	e8 8a de ff ff       	call   80103a20 <myproc>
80105b96:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105b99:	e8 82 de ff ff       	call   80103a20 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105bb5:	68 24 7b 10 80       	push   $0x80107b24
80105bba:	e8 e1 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105bbf:	83 c4 20             	add    $0x20,%esp
80105bc2:	e8 59 de ff ff       	call   80103a20 <myproc>
80105bc7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bce:	e8 4d de ff ff       	call   80103a20 <myproc>
...
80105be4:	0f 85 3e ff ff ff    	jne    80105b28 <trap+0x78>
    yield();
80105bea:	e8 21 e5 ff ff       	call   80104110 <yield>
...
80105bff:	e8 fc dd ff ff       	call   80103a00 <cpuid>
80105c04:	57                   	push   %edi
80105c05:	56                   	push   %esi
80105c06:	50                   	push   %eax
80105c07:	68 cc 7a 10 80       	push   $0x80107acc
...
80105c16:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c19:	e8 02 de ff ff       	call   80103a20 <myproc>
...
80105c3a:	0f 85 c8 00 00 00    	jne    80105d08 <trap+0x258>
    myproc()->tf = tf;
80105c40:	e8 db dd ff ff       	call   80103a20 <myproc>
80105c45:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c48:	e8 33 ef ff ff       	call   80104b80 <syscall>
    if(myproc()->killed)
80105c4d:	e8 ce dd ff ff       	call   80103a20 <myproc>
...
80105c63:	5d                   	pop    %ebp
      exit();
80105c64:	e9 47 e2 ff ff       	jmp    80103eb0 <exit>
...
80105cac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105cb0:	e8 4b dd ff ff       	call   80103a00 <cpuid>
80105cb5:	85 c0                	test   %eax,%eax
80105cb7:	0f 85 28 fe ff ff    	jne    80105ae5 <trap+0x35>
      acquire(&tickslock);
80105cbd:	83 ec 0c             	sub    $0xc,%esp
80105cc0:	68 80 3e 11 80       	push   $0x80113e80
80105cc5:	e8 f6 e9 ff ff       	call   801046c0 <acquire>
      wakeup(&ticks);
80105cca:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
      ticks++;
80105cd1:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
80105cd8:	e8 43 e5 ff ff       	call   80104220 <wakeup>
      release(&tickslock);
80105cdd:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105ce4:	e8 77 e9 ff ff       	call   80104660 <release>
...
80105dc7:	74 78                	je     80105e41 <uartinit+0xd1>
  uart = 1;
80105dc9:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
80105dd0:	00 00 00 
...
80105ddc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ddf:	bf e8 7b 10 80       	mov    $0x80107be8,%edi
...
80106acd:	68 f0 7b 10 80       	push   $0x80107bf0
...
80106ae3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ae6:	e8 15 cf ff ff       	call   80103a00 <cpuid>
  pd[0] = size-1;
...
80106baf:	e8 ec cd ff ff       	call   801039a0 <mycpu>
80106bb4:	89 c3                	mov    %eax,%ebx
80106bb6:	e8 e5 cd ff ff       	call   801039a0 <mycpu>
80106bbb:	89 c7                	mov    %eax,%edi
80106bbd:	e8 de cd ff ff       	call   801039a0 <mycpu>
80106bc2:	83 c7 08             	add    $0x8,%edi
80106bc5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106bc8:	e8 d3 cd ff ff       	call   801039a0 <mycpu>
...
80106cfb:	68 35 7c 10 80       	push   $0x80107c35
...
80106d60:	68 4f 7c 10 80       	push   $0x80107c4f
...
80106de8:	68 f0 7c 10 80       	push   $0x80107cf0
...
80106e89:	68 6d 7c 10 80       	push   $0x80107c6d
...
80106eeb:	68 85 7c 10 80       	push   $0x80107c85
...
80106fcc:	68 a1 7c 10 80       	push   $0x80107ca1
...
8010706b:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010709c:	68 b2 7c 10 80       	push   $0x80107cb2
...
80107112:	68 bc 7c 10 80       	push   $0x80107cbc
...
801071e7:	68 d6 7c 10 80       	push   $0x80107cd6
...
801072a0:	e8 7b d5 ff ff       	call   80104820 <memmove>
    len -= n;
    buf += n;
