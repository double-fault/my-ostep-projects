...
int main (int argc, char **argv) {
  ...
  11:	81 ec 08 04 00 00    	sub    $0x408,%esp
	int rc = fork();
  17:	e8 8f 03 00 00       	call   3ab <fork>
	if (rc < 0) error();
  1c:	85 c0                	test   %eax,%eax
  1e:	0f 88 c3 00 00 00    	js     e7 <main+0xe7>
	if (rc == 0) {
  24:	0f 84 99 00 00 00    	je     c3 <main+0xc3>
	...
	rc = fork();
  2a:	e8 7c 03 00 00       	call   3ab <fork>
	if (rc < 0) error();
  2f:	85 c0                	test   %eax,%eax
  31:	0f 88 b0 00 00 00    	js     e7 <main+0xe7>
	if (rc == 0) {
  37:	0f 84 af 00 00 00    	je     ec <main+0xec>
	...
	rc = fork();
  3d:	e8 69 03 00 00       	call   3ab <fork>
	if (rc < 0) error();
  42:	85 c0                	test   %eax,%eax
  44:	0f 88 9d 00 00 00    	js     e7 <main+0xe7>
	if (rc == 0) {
  4a:	8d bd e8 fb ff ff    	lea    -0x418(%ebp),%edi
  50:	0f 84 ba 00 00 00    	je     110 <main+0x110>
  56:	8d b5 e8 fc ff ff    	lea    -0x318(%ebp),%esi
		settickets(1);
		for (;;) ;
	}
  ...
  5f:	68 2c 01 00 00       	push   $0x12c
  64:	e8 da 03 00 00       	call   443 <sleep>
		struct pstat st;
		if (getpinfo(&st) < 0) error();
  69:	89 3c 24             	mov    %edi,(%esp)
  6c:	e8 ea 03 00 00       	call   45b <getpinfo>
  71:	83 c4 10             	add    $0x10,%esp
  74:	85 c0                	test   %eax,%eax
  76:	78 6f                	js     e7 <main+0xe7>
		printf(1, "\n");
  78:	52                   	push   %edx
  79:	89 fb                	mov    %edi,%ebx
  7b:	52                   	push   %edx
  7c:	68 91 08 00 00       	push   $0x891
  81:	6a 01                	push   $0x1
  83:	e8 98 04 00 00       	call   520 <printf>
		for (int i = 0; i < NPROC; ++i) {
  88:	83 c4 10             	add    $0x10,%esp
  8b:	eb 0a                	jmp    97 <main+0x97>
  8d:	8d 76 00             	lea    0x0(%esi),%esi
  90:	83 c3 04             	add    $0x4,%ebx
  93:	39 f3                	cmp    %esi,%ebx
  95:	74 c5                	je     5c <main+0x5c>
		       if (st.inuse[i]) {
  97:	8b 03                	mov    (%ebx),%eax
  99:	85 c0                	test   %eax,%eax
  9b:	74 f3                	je     90 <main+0x90>
			       printf(1, "PID: %d, tickets: %d, ticks: %d\n", st.pid[i], st.tickets[i], st.ticks[i]);
  9d:	83 ec 0c             	sub    $0xc,%esp
  a0:	ff b3 00 03 00 00    	push   0x300(%ebx)
  a6:	ff b3 00 01 00 00    	push   0x100(%ebx)
  ac:	ff b3 00 02 00 00    	push   0x200(%ebx)
  b2:	68 b0 08 00 00       	push   $0x8b0
  b7:	6a 01                	push   $0x1
  b9:	e8 62 04 00 00       	call   520 <printf>
  be:	83 c4 20             	add    $0x20,%esp
  c1:	eb cd                	jmp    90 <main+0x90>
		printf(1, "3 tickets with process %d\n", getpid());
  c3:	e8 6b 03 00 00       	call   433 <getpid>
  c8:	56                   	push   %esi
  c9:	50                   	push   %eax
  ca:	68 5d 08 00 00       	push   $0x85d
  cf:	6a 01                	push   $0x1
  d1:	e8 4a 04 00 00       	call   520 <printf>
		settickets(3);
  d6:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  dd:	e8 71 03 00 00       	call   453 <settickets>
  e2:	83 c4 10             	add    $0x10,%esp
		for (;;) ;
  e5:	eb fe                	jmp    e5 <main+0xe5>
	if (rc < 0) error();
  e7:	e8 54 00 00 00       	call   140 <error>
		printf(1, "2 tickets with process %d\n", getpid());
  ec:	e8 42 03 00 00       	call   433 <getpid>
  f1:	53                   	push   %ebx
  f2:	50                   	push   %eax
  ...
  fa:	e8 21 04 00 00       	call   520 <printf>
		settickets(2);
  ff:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 106:	e8 48 03 00 00       	call   453 <settickets>
 10b:	83 c4 10             	add    $0x10,%esp
		for (;;) ;
 10e:	eb fe                	jmp    10e <main+0x10e>
		printf(1, "1 ticket with process %d\n", getpid());
 110:	e8 1e 03 00 00       	call   433 <getpid>
 115:	51                   	push   %ecx
 116:	50                   	push   %eax
 117:	68 93 08 00 00       	push   $0x893
 11c:	6a 01                	push   $0x1
 11e:	e8 fd 03 00 00       	call   520 <printf>
		settickets(1);
 123:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 12a:	e8 24 03 00 00       	call   453 <settickets>
 12f:	83 c4 10             	add    $0x10,%esp
		for (;;) ;
 132:	eb fe                	jmp    132 <main+0x132>
...
void error() {
 ...
 143:	83 ec 10             	sub    $0x10,%esp
	printf(1, "some error occurred\n");
 146:	68 48 08 00 00       	push   $0x848
 14b:	6a 01                	push   $0x1
 14d:	e8 ce 03 00 00       	call   520 <printf>
	exit();
 152:	e8 5c 02 00 00       	call   3b3 <exit>
 ...
 47c:	89 d1                	mov    %edx,%ecx
{
 ...
 4a9:	0f b6 92 30 09 00 00 	movzbl 0x930(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 599:	ff 24 85 d8 08 00 00 	jmp    *0x8d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6a7:	90                   	nop
          s = "(null)";
 6a8:	ba d1 08 00 00       	mov    $0x8d1,%edx
        while(*s != 0){
 ...
 6c1:	a1 00 0c 00 00       	mov    0xc00,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 00 0c 00 00    	mov    %edx,0xc00
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 00 0c 00 00    	mov    %edx,0xc00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 00 0c 00 00    	mov    0xc00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 4f                	jae    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	8b 3d 00 0c 00 00    	mov    0xc00,%edi
 ...
 7ca:	e8 f1 fe ff ff       	call   6c0 <free>
  return freep;
 7cf:	8b 15 00 0c 00 00    	mov    0xc00,%edx
 ...
 817:	0c 00 00 
    base.s.size = 0;
 81a:	bf 04 0c 00 00       	mov    $0xc04,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 08 0c 00 00 00 	movl   $0x0,0xc08
 832:	00 00 00 
    if(p->s.size >= nunits){
